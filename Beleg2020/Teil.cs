...
namespace Beleg2020
{
    class Teil
    {
         ...
         /// <summary>
         /// Liefert den nächsten Verarbeitungsschritt
         /// </summary>
         /// <returns>Verarbeitungsschritt wenn keiner mehr da dann UNDEFINIERT</returns>
         ...
         /// <summary>
         /// Der Getter für die Seriennummer
         /// </summary>
         /// <returns>Seriennummer als String</returns>
